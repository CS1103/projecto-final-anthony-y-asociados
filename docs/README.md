...
<pre lang="text"> . ├── CMakeLists.txt ├── docs │ ├── BIBLIOGRAFIA.md │ ├── LICENSE │ └── README.md ├── include │ └── utec │ ├── agent │ │ ├── EnvGym.h │ │ └── PongAgent.h │ ├── algebra │ │ └── Tensor.h │ ├── nn │ │ ├── activation.h │ │ ├── dense.h │ │ ├── layer.h │ │ ├── loss.h │ │ ├── neural_network.h │ │ └── optimizer.h │ └── threading │ └── ThreadPool.h ├── src │ ├── bench │ │ ├── bench_seq.cpp │ │ └── bench_thread.cpp │ ├── main.cpp │ └── utec │ ├── agent │ │ ├── EnvGym.cpp │ │ └── PongAgent.cpp │ └── threading │ └── ThreadPool.cpp ├── tests │ ├── test_agent_env.cpp │ ├── test_neural_network.cpp │ └── test_tensor.cpp </pre>
